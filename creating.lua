...
cmd:option('-image_size', 1080, 'Maximum height / width of generated image')
cmd:option('-gpu', '0', 'Zero-indexed ID of the GPU to use; for CPU mode set -gpu = -1')
cmd:option('-multigpu_strategy', '', 'Index of layers to split the network across GPUs')

-- Optimization options
cmd:option('-content_weight', 10)
cmd:option('-style_weight', 1000)
cmd:option('-tv_weight', 0.0001)
...
cmd:option('-content_layers', 'relu1,relu7,relu12', 'layers for content')
cmd:option('-style_layers', 'relu1,relu3,relu5,relu7,relu9', 'layers for style')
